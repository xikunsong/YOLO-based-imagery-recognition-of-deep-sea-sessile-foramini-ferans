...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp16/weights/best_ckpt.pt', help='model path(s) for inference.')
...
def run(weights=osp.join(ROOT, 'yolov6s.pt'),
        ...
        save_txt=True,
        not_save_img=False,
        save_dir='D:/work/2023/SAM/YOLOv6-main/tools/runs/inference/exp/',
        view_img=True,
        classes=None,
        agnostic_nms=False,
    ...
    # Inference
    save_dir = osp.join(ROOT, 'results')
